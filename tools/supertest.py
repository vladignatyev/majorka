...
class PartialParametersInPostback(EnvironmentTestCase):
    @hang
    def test_partial(self):
        ...
        for i in range(1000):
            ...
            if random.random() <= prob:
                # partial postback parameters as yobany propeller does it
                postback_url = self.majorka.majorka_url().set(None, 'postback').add({
